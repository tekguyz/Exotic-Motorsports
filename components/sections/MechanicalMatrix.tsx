      ...
      <div className="container mx-auto relative z-10">
        <div className="mb-16 md:w-2/3">
          <h2 className="font-heading text-3xl md:text-4xl text-titanium uppercase tracking-tight">
            Diagnostic <span className="text-[#10FF00]">Services</span>
          </h2>
          <p className="text-grey-bore mt-4 max-w-2xl text-lg">
            Factory-level diagnostics, exact specification differential fluid changes, and complete carbon-ceramic brake system overhauls.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {CORE_SERVICES.map((protocol, idx) => {
            ...
            return (
              ...
              >
                <Card className="bg-carbon border-white/5 p-8 rounded-none relative overflow-hidden group h-full hover:border-[#10FF00]/30 transition-colors duration-500">
                  ...
                  <CardContent className="p-0 relative z-10 h-full flex flex-col justify-between">
                    <div>
                      <div className="h-12 w-12 bg-onyx border border-white/10 flex items-center justify-center mb-6 text-[#10FF00]">
                    ...
                    <div className="mt-8 flex items-center gap-2 text-[#10FF00] font-mono text-xs uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-opacity duration-300">

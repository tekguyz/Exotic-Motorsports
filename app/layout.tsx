...
export default function RootLayout({children}: {children: React.ReactNode}) {
  return (
    <html lang="en" className={cn("font-sans dark", inter.variable, archivoBlack.variable)}>
      <body className="bg-onyx text-titanium min-h-screen antialiased selection:bg-acid-green selection:text-onyx" suppressHydrationWarning>
        {children}
      </body>
    </html>
  );
